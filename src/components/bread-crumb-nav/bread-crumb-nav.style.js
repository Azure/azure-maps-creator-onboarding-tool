...
export const breadcrumbStyle = {
  ...
  itemLink: { color: color.accent.primary, fontSize: fontSize.md, fontWeight: fontWeight.normal, lineHeight: '1rem',
    selectors: {
      ':last-child': { color: color.accent.primary, fontSize: fontSize.md, fontWeight: fontWeight.normal, lineHeight: '1rem' },
