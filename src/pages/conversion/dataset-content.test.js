...
describe('dataset content', () => {
  it('should render nothing when not selected', () => {
    const view = render(<DatasetContent datasetStepStatus={0} datasetOperationLog={'http://log.com'} datasetId={152} selectedStep={1} />);
  ...
  it('should render dataset content', () => {
    ...
    const view = render(<DatasetContent datasetStepStatus={1} datasetOperationLog={operationLog} datasetId={'zxcv-data-zxcvzxcv-set-dgfh'} selectedStep={2} />);
    expect(view).toMatchSnapshot();
  });
});