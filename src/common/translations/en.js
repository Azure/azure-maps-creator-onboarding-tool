const en = {
  translation: {
    ...
    'error.layer.name.should.begin.with.letter': 'Feature class name must begin with a upper case or lower case character.',
    ...
    'error.prop.name.should.begin.with.letter': 'Property name must begin with a upper case or lower case character.',
