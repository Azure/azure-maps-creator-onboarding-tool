const en = {
  translation: {
    ...
    'diagnostic.description.text': 'Azure Maps provides a visual experience for viewing the error logs through a diagnostic package. More information can be found in the <0>documentation</0>.',
